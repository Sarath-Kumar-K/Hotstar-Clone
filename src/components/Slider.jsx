...
const Slider = () => {
  ...
  const Movies = movieList.map(item=>{
    return <img key={item.backdrop_path} src={ImageBaseUrl+item.backdrop_path} className='hover:border-4 hover:shadow-lg shadow-black border-gray-300 transition-all duration-200 ease-in-out min-w-full md:h-[400px] mr-5 rounded-lg object-cover object-left-top' alt="movie"/>
  })
